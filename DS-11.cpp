...
int main(void)
{
    ...
    do
    {
        ...
        << "(6) Count the non-leaf, leaf and total number of nodes \n"
        << "(7) Search for an element x in the BST and change its value to y\n"
        << " and then place the node with value y at its appropriate position\n"
        << "(8) Display height of tree\n"
        << "(9) Perform deletion by merging\n"
        << "(10) Perform deletion by copying\n"
        << "(0) Exit\n\n";
        cout << "Enter Choice: ";
        cin >> choice;
        switch (choice)
